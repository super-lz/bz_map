...
import com.bz.flutter.map.core.MapController;
import com.bz.flutter.map.overlays.marker.MarkersController;
import com.bz.flutter.map.overlays.polygon.PolygonsController;
import com.bz.flutter.map.overlays.polyline.PolylinesController;
import com.bz.flutter.map.utils.LogUtil;
...
public class AMapPlatformView
    ...
    AMapPlatformView(int id,
        ...
        methodChannel = new MethodChannel(binaryMessenger, "bz_map_" + id);
