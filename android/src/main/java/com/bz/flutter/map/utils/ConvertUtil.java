package com.bz.flutter.map.utils;
...
import com.bz.flutter.map.core.AMapOptionsSink;
...
public class ConvertUtil {
    ...
    private static final String PACKAGE_NAME = "bz_map";
...
//        }
    ...
    private static String lookupKeyForAsset(String asset) {
        return FlutterInjector.instance().flutterLoader().getLookupKeyForAsset(asset, PACKAGE_NAME);
    }
